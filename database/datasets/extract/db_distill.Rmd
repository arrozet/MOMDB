...
movie_keywords <- raw_movies |>
  ...
  select(movie_id = movie_id, keyword_id, keyword_name) |>
  arrange(movie_id, keyword_id, keyword_name)

keywords <- movie_keywords |>
  distinct(keyword_id, keyword_name) |>
  arrange(keyword_id, keyword_name)
