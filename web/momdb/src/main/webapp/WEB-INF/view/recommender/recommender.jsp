    ...
    <div class="container">
        <div class="columns">
            <div class="column is-half is-offset-one-quarter">
                <form:form method="POST" action="/recommender/filtrar" modelAttribute="filtro">
        ...
        <div class="is-mobile is-multiline is-vcentered" style="margin-bottom: 1.5rem;">
            <form:form method="POST" action="/recommender/filtrar" modelAttribute="filtro" class="column is-12">
                <div class="columns is-mobile is-vcentered is-flex is-align-items-flex-end">
                    ...
                    <div class="column is-2">
                        ...
                        <form:select path="popularityRange" class="user select is-warning has-background-grey is-fullwidth">
        ...
        <nav class="pagination is-centered mt-5" role="navigation" aria-label="pagination">
            <%-- Previous Button --%>
            <% if (currentPage > 1) { %>
            <a href="/recommender/?page=<%= currentPage - 1 %>" class="pagination-previous">Previous</a>
            <% } else { %>
            ...
            <a href="/recommender/?page=<%= currentPage + 1 %>" class="pagination-next">Next</a>
            <% } else { %>
